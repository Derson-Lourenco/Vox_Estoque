...
<body class="bg-light">
  <div class="container-fluid bodyCor">
    <div class="row bodyCor">
      ...
      <nav class="col-md-9 ml-sm-auto col-lg-10 bg-light">
            ...
            <head>
              ...
              <script type="text/javascript">
                ...
                function drawVisualization() {
                  ...
                  var data = google.visualization.arrayToDataTable([
                    ['', 'Chamex', 'Caderno', 'Lápis de cor', 'Caneta', 'Borracha', 'Base'],
                    ['1º Semana', 12, 938, 522, 998, 450, 614.6],
                    ['2º Semana', 135, 1120, 599, 1268, 288, 682],
                    ['3º Semana', 157, 1167, 587, 807, 397, 623],
                    ['4º Semana', 139, 1110, 615, 968, 215, 609.4],
                  ]);

                  var options = {
                    title: 'Os 5 Produtos Mais Vendidos',
                    vAxis: {
                      title: 'Quantidade'
                    },
                    hAxis: {
